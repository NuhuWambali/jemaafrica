...
const BRANCHES = [
  { city: 'Mwanza Branch', address: 'Mkuyuni Street.', phone: '+255 769 498 997' },
  { city: 'Saza Branch', address: 'Kimborokoto Street.', phone: '+255 629 260 739' },
  { city: 'Kahama Branch', address: 'Mbulu Street.', phone: '+255 743 550 535' },
  { city: 'Chunya Branch', address: 'Sinza Street.', phone: '+255 627 067 369' },
  { city: 'Geita Branch', address: 'Mpomvu Street.', phone: '+255 745 694 989' },
  { city: 'Musoma Branch', address: 'Musoma Bus Stop.', phone: '+255 677 079 517' },
];
